...
## Project Structure
    ...
    ├── testapiautodatamod_126450  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_126450`
...
2. Clone this repo and `cd testapiautodatamod_126450`
